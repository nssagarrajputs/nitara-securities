...
const features = [
    {
        ...
        description:
            "Trade with our firm's capital, not your personal savings.",
    },
    {
        icon: TrendingUp,
        title: "Multi-Market Access",
        description:
            "Execute trades across NSE, BSE, F&O, and commodity markets.",
    },
    {
        icon: Zap,
        title: "Advanced Technology",
        description:
            "Leverage our algo trading terminal built for speed and precision.",
    },
    {
        icon: Shield,
    ...
    },
    {
        ...
        description:
            "Learn from seasoned professionals and grow within a collaborative trading.",
    },
    {
        icon: Target,
            ...
            <div className="mx-auto max-w-7xl">
                ...
                >
                    ...
                    <p className="text-twilight-600 mx-auto max-w-3xl text-lg leading-relaxed">
                        ...
                        We operate an in-house trading desk where
                ...
                >
                    <div className="mx-auto max-w-4xl text-center">
                        ...
                        <p className="text-twilight-700 text-lg leading-relaxed">
                            ...
                            . Whether {"you're"} an experienced trader looking
                            for capital backing or a newcomer eager to learn, we
