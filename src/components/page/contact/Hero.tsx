...
export default function Hero() {
    return (
        <section className="from-twilight-900 via-twilight-800 to-pacific-900 relative min-h-[50vh] overflow-hidden bg-linear-to-br px-4 pt-32 pb-20 lg:pt-40 lg:pb-28">
            {/* Background Pattern */}
            ...
            <div className="relative mx-auto max-w-4xl text-center">
                ...
                <motion.p
                    ...
                    className="text-twilight-200 mx-auto max-w-2xl text-lg leading-relaxed md:text-xl"
                >
                    Have questions about our trading desk, career opportunities,
                    or application process? Reach out and {"we'll"} respond
                    promptly.
                </motion.p>
            </div>
        </section>
