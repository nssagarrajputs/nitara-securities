        ...
        >
            ...
            <div className="relative mx-auto max-w-5xl">
                ...
                >
                    ...
                    <p className="text-twilight-200 mx-auto mb-10 max-w-3xl text-lg leading-relaxed md:text-xl">
                        Take the first step toward a professional trading
                        career. Whether you're experienced or just starting out,
                ...
                >
                    <div className="border-pacific-500/30 bg-twilight-800/30 rounded-2xl border p-8 backdrop-blur-sm md:p-10">
                        <h3 className="mb-6 text-center text-xl font-bold text-white">
                            Just make a call or send us a mail
                        </h3>
                        ...
                        <div className="border-twilight-600 mt-8 border-t pt-8 text-center">
                            <p className="text-twilight-300">
                                We review all applications and respond within
                                2-3 business days.
                            </p>
                        </div>
                    </div>
                ...
                >
                    <p className="text-twilight-300">
                        ...
                        <Link
                            href="/contact"
                            className="text-pacific-400 hover:text-pacific-300 font-semibold underline transition-colors"
                        >
                            Contact us
                        </Link>{" "}
